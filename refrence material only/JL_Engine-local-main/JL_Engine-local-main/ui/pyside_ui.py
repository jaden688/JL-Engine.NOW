...
class Main(QMainWindow):
    ...
    def __init__(self, chat_only_mode: bool | None = None):
        ...
        self.badge_agent = QLabel(
            f"{'Operator' if self.chat_only_mode else 'Agent'}: {badge_agent_label}"
        )
    ...
    def _build_console_tab(self, parent: QWidget) -> None:
        ...
        if self.chat_only_mode:
            ...
            self.chat_log.setPlainText(
                ...
                f"SYSTEM: Operator '{self.engine.current_agent_name}' loaded.\n"
            ...
            operator_label.setMinimumWidth(72)
            ...
            operator_row.addWidget(self.agent_combo, 1)
            input_panel_layout.addLayout(operator_row)
            ...
            # Keep one visible operator while allowing specialist workers to assist in the background.
            ...
            self.chat_all_workers_toggle.setToolTip(
                "Run a multi-agent worker crew and merge results back into the active operator voice."
            )
        ...
        self.chat_all_workers_toggle.setChecked(self._env_flag("JL_UI_ALL_WORKERS", False))
        self.chat_all_workers_toggle.setToolTip(
            "Run specialist workers in parallel and merge them through the active operator."
        )
    ...
    def _setup_dock_controls(self) -> None:
        ...
        self.agent_combo.addItems(self._agent_options())
        self.agent_combo.setCurrentText(self.engine.current_agent_name)
        agent_card = make_card("Active Agent", "Selects the active operator. Different agents have different system prompts, core drives, and behavioral constraints.")
    ...
    def _build_engine_controls(self, parent_layout: QVBoxLayout) -> None:
        ...
        agent_card = make_card("Agent", "Selects the active operator/profile.")
    ...
    def _sync_badges(self) -> None:
        ...
        if self.chat_only_mode:
            ...
            self.badge_agent.setText(f"Operator: {agent}")
