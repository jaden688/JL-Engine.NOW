...
# Run python module. Pinned to system Python 3.12 via the py launcher so it never
# resolves to the Claude Code (hermes) runtime that sits earlier on PATH.
& py -3.12 -m ui.pyside_ui
