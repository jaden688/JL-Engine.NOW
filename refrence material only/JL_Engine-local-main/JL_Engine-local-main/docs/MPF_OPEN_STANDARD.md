...
- the old root `operators/` mirror has been retired
- `jl_engine_core/data/operators/` remains only as a legacy compatibility mirror and should not be edited directly
