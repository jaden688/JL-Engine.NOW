...
def agent_list_mpf() -> str:
    """List all MPF (Modular Operator Framework) agents in the registry."""
...
@mcp.tool()
def agent_list_operators() -> str:
    """List available MPF operators."""
    return _get("/quest/operators/mpf")
...
def agent_build_business(
    ...
    """Build a new business-operator agent from scratch.
    Args:
